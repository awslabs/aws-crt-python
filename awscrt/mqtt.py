...
class Connection(NativeResource):
    ...
    Args:
        ...
        websocket_proxy_options (Optional[awscrt.http.HttpProxyOptions]):
            Optional proxy options for websocket connections.  Deprecated by proxy_options.
        ...
        proxy_options (Optional[awscrt.http.HttpProxyOptions]):
            Optional proxy options for all connections.  Supercedes websocket_proxy_options.
        """
