...
/Library/Frameworks/Python.framework/Versions/3.4/bin/python3 seutp.py bdist_wheel
/Library/Frameworks/Python.framework/Versions/3.5/bin/python3 seutp.py bdist_wheel
/Library/Frameworks/Python.framework/Versions/3.6/bin/python3 seutp.py bdist_wheel
/Library/Frameworks/Python.framework/Versions/3.7/bin/python3 seutp.py sdist bdist_wheel
