...
MACOSX_DEPLOYMENT_TARGET=10.15 /Library/Frameworks/Python.framework/Versions/3.8/bin/python3 -m build
MACOSX_DEPLOYMENT_TARGET=10.15 /Library/Frameworks/Python.framework/Versions/3.9/bin/python3 -m build
MACOSX_DEPLOYMENT_TARGET=10.15 /Library/Frameworks/Python.framework/Versions/3.10/bin/python3 -m build
MACOSX_DEPLOYMENT_TARGET=10.15 /Library/Frameworks/Python.framework/Versions/3.11/bin/python3 -m build
...
MACOSX_DEPLOYMENT_TARGET=10.15 /Library/Frameworks/Python.framework/Versions/3.13/bin/python3 -m build
