...
class SetupForTests(Builder.Action):
    ...
    def run(self, env):
        ...
        self._setenv_tmpfile_from_secret('AWS_TEST_MQTT5_IOT_KEY_PATH', 'ci/mqtt5/us/Mqtt5Prod/key', 'mqtt5certificate.pem')
        self._setenv_tmpfile_from_secret('AWS_TEST_MQTT5_IOT_CERTIFICATE_PATH', 'ci/mqtt5/us/Mqtt5Prod/cert', 'mqtt5privatekey.pem')
