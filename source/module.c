...
static PyMethodDef s_module_methods[] = {
    ...
    AWS_PY_METHOD_DEF(cbor_encoder_write_str, METH_VARARGS),
    ...
    AWS_PY_METHOD_DEF(cbor_decoder_pop_next_double, METH_VARARGS),
    AWS_PY_METHOD_DEF(cbor_decoder_pop_next_bool, METH_VARARGS),
    AWS_PY_METHOD_DEF(cbor_decoder_pop_next_bytes, METH_VARARGS),
    AWS_PY_METHOD_DEF(cbor_decoder_pop_next_str, METH_VARARGS),
