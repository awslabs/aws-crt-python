...
static PyMethodDef s_module_methods[] = {
    ...
    /* HTTP connetion */
    {"aws_py_http_connection_close", aws_py_http_connection_close, METH_VARARGS, NULL},
    {"aws_py_http_connection_is_open", aws_py_http_connection_is_open, METH_VARARGS, NULL},
