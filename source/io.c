...
/* aws_input_stream implementation for accessing Python's io.RawIOBase */
...
struct input_stream_binding {
    struct aws_input_stream *native;
};

static void s_input_stream_capsule_destructor(PyObject *capsule) {
